...
import { ArrowRight, Brain, Gauge, Users } from "lucide-react";
		...
		<section className="relative py-32">
			<div className="container">
				<div className="text-center">
					<a
						href="#"
						className="bg-card mx-auto mb-3 inline-flex items-center gap-3 rounded-full border px-2 py-1 text-sm"
					>
					...
					<h1 className="mx-auto mt-4 mb-3 max-w-3xl text-4xl font-semibold text-balance lg:mb-7 lg:text-7xl">
						Go beyond what basic LLMs can do
					</h1>
					<p className="m text-muted-foreground mx-auto max-w-3xl lg:text-xl">
						Renegent expands on your favorite LLMs, making it easy
						for
