	...
	return (
		<>
			<Illustration1
				...
				className="absolute top-0 left-1/2 -translate-x-1/2 scale-150"
			/>
			<Illustration1
				initial={{ opacity: 0, y: -100 }}
				animate={{ opacity: 1, y: 0 }}
			...
			<Illustration2
				...
				transition={{ duration: 1, ease: [0, 0, 0, 1.12] }}
				className="absolute top-1/2 left-0 z-99 hidden -translate-y-1/2 scale-150 md:block"
			/>
			<Illustration2
				initial={{ opacity: 0, x: -100 }}
				animate={{ opacity: 1, x: 0 }}
				transition={{ duration: 1, ease: [0, 0, 0, 1.12] }}
				className="absolute top-1/2 right-0 z-99 hidden -translate-y-1/2 scale-150 scale-x-[-1] md:block"
			/>
		</>
	);
}
