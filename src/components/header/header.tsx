		...
		dropdownItems: [
			{
				...
				href: "#",
				description: "Crafting a powerful AI have never been easier.",
			},
			{
				title: "Knowledge Base",
				href: "#",
				description:
					"Give your AI some context to work with. Upload any file type and we'll handle the rest.",
			},
			{
				title: "Powerful Tools",
				href: "#",
				description:
					"Shop from a marketplace of 100+ tools to use in your AI.",
			},
		],
	},
...
export default function Header() {
	...
	return (
		<section className="bg-background/70 absolute top-5 left-1/2 z-50 w-[min(90%,700px)] -translate-x-1/2 rounded-full border backdrop-blur-md lg:top-12">
						...
						{ITEMS.map((link) =>
							link.dropdownItems ? (
								...
								>
									...
									<NavigationMenuContent>
										<ul className="w-[400px] space-y-2 p-2">
